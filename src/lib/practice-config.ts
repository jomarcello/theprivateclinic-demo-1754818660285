...
export const practiceConfigs: Record<string, PracticeConfig> = {
  'theprivateclinic': {
    ...
    location: 'London, UK',
    agentId: 'agent_1754818660284_theprivateclinic',
    type: 'beauty' as const,
    
    chat: {
      assistantName: 'Robin',
      initialMessage: 'Thank you for contacting Theprivateclinic Clinic! I am Robin, your beauty assistant. How can I help you today?',
      systemPrompt: `You are Robin, the assistant at Theprivateclinic Clinic. Help patients with beauty services.`
    },
